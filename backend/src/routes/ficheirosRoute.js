...
function getDestination(req, file, cb) {
    ...
    if (req.params.idEnt && req.params.idCand && req.params.idOferta) {
      // Rota /entrevistas/:idEnt/candidaturas/:idCand/ofertas/:idOferta/create
      ...
      // Rota /interacoes/:idInt/contactos/:idCont/oportunidades/:idOp/create
      ...
      folder += `/oportunidades${req.params.idOp}/reunioes${req.params.idOp}`;
    }
